...
- [ ] Ship VPS-first `create-shibumi` with static, Bun web, and SQLite full-stack starts (`.plans/cli-vps-release.md`). Workstreams 1 (foundation), 2 (public-repo migration + Ship byte-lock), 3 (Bun web template), and 4 (Ship v42 static mode + thin static template, all codex-reviewed and container-verified) done 2026-08-23; next: SQLite full-stack template (ws5). Source in `../create-shibumi`; npm publish stays manual/owner-only at ws7.
