...
- [ ] Ship VPS-first `create-shibumi` with static, Bun web, and SQLite full-stack starts (`.plans/cli-vps-release.md`). Workstreams 1 (foundation), 2 (public-repo migration + Ship v41 byte-lock), and 3 (Bun web template, codex-reviewed, container-verified) done 2026-08-23; next: static template rebuild (ws4). Source in `../create-shibumi`; npm publish stays manual/owner-only at ws7.
