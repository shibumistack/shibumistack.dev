...
const sourceUrl = "https://shibumistack.dev/ship/v51.ts";
const knownSourceHashes = new Set([
  ...
  "900498fea7658b6bd0349919b64a92a70b2e14aad49a1b6e906e6db68bf50410",
  "089cebd9514c6bac9409f424f6aa7246777a90f85724b1953fb1d03709d11dea",
  "3bf1c3673f3f797351a068c7a3d992c66ffe3436d28a7cbacef390cbe4ef03c9",
  "b1ee3e53268dc9c4ccbf61c27e177e2face7d84604fd32aa170895477d91bd5e",
  "77db8f7f5a829f8353e6db6a0f42e606a5dd05101f0529f34f542e91e93babb4",
  "463892742330445873189052283b2e4387bba76ec1de8f5d2b01622679d8062f",
  "2b72555cc851c5cfed653e9a20de3d41f03007afd5f90ed4692b0d88ef34b4c6",
  "9556364e710f8e1cfc216db95eda3748ce8c5710730c660c369fc13145b221e9",
  "a4370041e41bb308839a6165760e055c3e961f206af2a7d45ab3a8c6c7a34166",
  "08616fd18a7c5822c1edfe3b0eb42c97dc407d006a6169cbdb46a989f37c85cb",
  "d76bf876aa4f444f03a0f037d4e728bdbafea5014a52110b684ee15a91a6753a",
  "bef52b9135b74330b83313ba273140cbcd8f7ba1f2d717ea772e0f16a6e0a408",
  "649764b655697daa55f2c163e9c8743be6124767c43698954f6b97737efa9095",
  "a319cd23e85e4add4d0ab1753a936349af136a97d3ca9907beca79cf05442f86",
  "d24fbec6439a0349548527bf775443dbd3cfc37649b29a8f121cf204b00b6c20",
  ...
  "73f45cbea9a8b7b1c71b80921728d4e700859e8f85cb4fcf1885f0e370fafe51",
]);
...
if (await existingFile.exists()) {
  ...
  if (existing !== source && !knownSourceHashes.has(hash(existing))) {
    fail("scripts/ship.ts contains owned changes.\nNext: review and merge https://shibumistack.dev/ship/v51.ts manually.");
  }
}

// Keep Clack in project dependencies for every future ship run.
const dependency = await command([process.execPath, "add", "--dev", "@clack/prompts@^1.7.0"]);
