...
await write(join(output, "install", "ship"), await responseBody("/ship/install-v38.ts"));
await write(join(output, "install", "ship.sh"), await responseBody("/ship/bootstrap-v28.sh"));
