...
await write(join(output, "install", "ship"), await responseBody("/ship/install-v36.ts"));
await write(join(output, "install", "ship.sh"), await responseBody("/ship/bootstrap-v21.sh"));
