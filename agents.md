...
- Ship v43 batch (pending, do with next ship.ts change): add `.xml:application/xml` to staticHttpdConf (RSS/sitemap content type), rename "Static output" label to "Static site" in ship:setup prompt.
