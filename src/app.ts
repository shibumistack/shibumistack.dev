...
app.get("/install/ship", (c) => c.redirect("/ship/install-v26.ts", 302));
app.get("/install/ship.sh", (c) => c.redirect("/ship/bootstrap-v19.sh", 302));
app.get("/ship/latest.ts", async (c) => c.body(await read("public/ship/v28.ts"), 200, {
