...
app.get("/install/ship", (c) => c.redirect("/ship/install-v29.ts", 302));
app.get("/install/ship.sh", (c) => c.redirect("/ship/bootstrap-v22.sh", 302));
app.get("/ship/latest.ts", async (c) => c.body(await read("public/ship/v31.ts"), 200, {
