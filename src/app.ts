...
app.get("/install/ship", (c) => c.redirect("/ship/install-v27.ts", 302));
app.get("/install/ship.sh", (c) => c.redirect("/ship/bootstrap-v20.sh", 302));
app.get("/ship/latest.ts", async (c) => c.body(await read("public/ship/v29.ts"), 200, {
