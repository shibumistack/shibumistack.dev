...
app.get("/install/ship", (c) => c.redirect("/ship/install-v11.ts", 302));
app.get("/install/ship.sh", (c) => c.redirect("/ship/bootstrap-v4.sh", 302));
app.get("/ship/latest.ts", async (c) => c.body(await read("public/ship/v13.ts"), 200, {
