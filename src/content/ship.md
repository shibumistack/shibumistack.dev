...
Requirements: Bun, Git, Docker Desktop or compatible Docker Engine, and SSH access to your Linux server. Deploy-on-push also uses GitHub CLI.
...
Source: <https://shibumistack.dev/ship/v30.ts>
