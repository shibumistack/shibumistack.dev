...
Requirements: Bun, Git, Colima or another Docker-compatible engine, and SSH access to your Linux server. Deploy-on-push also uses GitHub CLI.
...
Source: <https://shibumistack.dev/ship/v31.ts>
